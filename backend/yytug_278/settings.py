"""
Django settings for yytug_278 project.
...
WSGI_APPLICATION = 'yytug_278.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "yytug_278 API",
    "DESCRIPTION": "API documentation for yytug_278 App",
    "VERSION": "v1",
}
